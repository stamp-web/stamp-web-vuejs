...
import CatalogueValueCellEditor from '@/components/renderers/editors/CatalogueValueCellEditor.vue'
...
import UpdatedCellRenderer from '@/components/renderers/UpdatedCellRenderer.vue'
...
export function createCatalogueUpdateColumnDefs(prefPaths: PreferencePaths): ColumnDefinition[] {
  const { t } = useI18n()
  return [
    new ColumnDefinition('', {
      cellRenderer: ImagePreviewCellRenderer,
    ...
    new ColumnDefinition('', {
      ...
      cellRenderer: ConditionCellRenderer,
      cellRendererParams: {
        path: 'activeCatalogueNumber.condition'
      },
      colId: 'condition',
      headerName: t('table-columns.condition'),
      maxWidth: 170,
    ...
    new ColumnDefinition('activeCatalogueNumber.unknown', {
      cellClass: ['!pr-0.25', 'ag-cell-checkbox'],
      colId: 'unknown',
      editable: true,
      headerName: t('table-columns.unknown'),
      maxWidth: 100,
      sortable: false,
    ...
    new ColumnDefinition('activeCatalogueNumber.value', {
      cellClass: ['!pr-0.25'],
      cellRenderer: CatalogueValueCellRenderer,
      cellEditor: CatalogueValueCellEditor,
      colId: 'newValue',
      editable: (params: { data: Stamp }) => {
        return !params.data?.activeCatalogueNumber?.unknown
      },
      headerName: t('table-columns.new-catalogue-value'),
      maxWidth: 150,
      sortable: false
    }),
    new ColumnDefinition('updated', {
      cellClass: ['!pr-0.25'],
      colId: 'updated',
      sortable: false,
